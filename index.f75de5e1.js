...
thead.addEventListener("click", (e)=>{
    ...
    if (columnIndex !== lastSortedColumnIndex) sortOrder = "asc";
    const sortedRows = rows.sort((rowA, rowB)=>{
        ...
        let comparison = 0;
        if (cellAHasDigits && cellBHasDigits) comparison = convert(cellA) - convert(cellB);
        if (!cellAHasDigits && !cellBHasDigits) comparison = cellA.localeCompare(cellB);
...
tbody.addEventListener("dblclick", (e)=>{
    ...
    if (tbody.querySelector(".cell-input")) tbody.querySelector(".cell-input").blur();
